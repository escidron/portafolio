...
export default function NavBar() {
  ...
  >
   ...
   <Link activeClass="active" to="about"  smooth={true} offset={50} duration={300} className='text-[#ebe7d7ea]  md:text-lg font-medium ml-8'><h1 className='links'>About me</h1></Link>
